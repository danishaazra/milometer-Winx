...
class _MillsState extends State<Mills> {
      ...
      child: Padding(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color:widget.isSelected ? Colors.blue.withOpacity(0.5) : Colors.black.withOpacity(0.2),
                blurRadius: 4,
                spreadRadius: 2,
  ...
  Text labelName() {
    if (widget.label == '') {
      return Text(widget.raspberrypi_id, style: TextStyle(fontSize: 18),);
    } else {
      return Text(widget.label, style: TextStyle(fontSize: 18),);
